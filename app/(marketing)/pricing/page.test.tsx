...
describe("pricing page", () => {
  ...
  it("keeps paid CTAs active when the user is not on a matching subscription", async () => {
    ...
    expect(screen.getAllByText("60 AI tutor questions per day")).toHaveLength(2);
    expect(
      screen.getByText(
        "Guests can try 3 demo questions before login. Free accounts get 10 tutor questions per day, and Pro plans increase that to 60 questions per day.",
      ),
    ).toBeInTheDocument();
  });
});
